...
import XCTest
@testable import SpvChannelsSdk
...
class SpvChannelApiTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        messagingApi = SpvMessagingApi(baseUrl: "https://mock", channelId: "m1", token: "m2", notificationService: nil, encryption: SpvNoOpEncryption(), networkSession: mockSession)
    }
